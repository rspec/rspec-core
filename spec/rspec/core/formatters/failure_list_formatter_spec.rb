  ...
  RSpec.describe FailureListFormatter do
    ...
    it 'produces the expected full output' do
      ...
      expect(output).to eq(<<-EOS.gsub(/^\s+\|/, ''))
        ...
        |./spec/rspec/core/resources/formatter_specs.rb:37:expected: 2 got: 1 (compared using ==)
        |./spec/rspec/core/resources/formatter_specs.rb:41:expected: 2 got: 1 (compared using ==)
        |./spec/rspec/core/resources/formatter_specs.rb:42:expected: 4 got: 3 (compared using ==)
        |./spec/rspec/core/resources/formatter_specs.rb:50:foo
